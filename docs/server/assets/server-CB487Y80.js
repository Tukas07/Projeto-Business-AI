...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v--GQFgd-V.js");
...
const manifest = {
  "b427c7c61f8e863d7131fa3a4a4d0e780e7af3a6dfbb17b0c1df25df31c357b0": {
    functionName: "chatWithConsultant_createServerFn_handler",
    importer: () => import("./chat.functions-DV7_O3nM.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DTicDenU.js").then((n) => n.r),
    import("./start-Cqxg_9tF.js"),
