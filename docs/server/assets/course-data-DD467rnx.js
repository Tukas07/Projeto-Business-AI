...
const MODULES = [
  {
    ...
    lessons: [
      ...
      {
        id: "1.2",
        title: "Descrições de produto e anúncios que vendem",
        youtube: "",
        c: {
          tool: "ChatGPT.",
      ...
      {
        id: "1.3",
        title: "Artes e imagens simples com IA",
        youtube: "",
        c: {
          tool: "Canva com IA, e ferramentas de imagem gratuitas.",
    ...
    quiz: [
      {
        ...
        a: 1,
        e: "Peça 5 opções e ajuste a que mais combina com o seu negócio."
      },
      {
        ...
        a: 1,
        e: "Texto claro com o benefício na frente vende mais, e sai de graça com IA."
      },
      {
        ...
        a: 1,
        e: "Modelo pronto mais IA dão visual profissional rápido e barato."
      }
    ]
  },
  {
    id: 2,
    num: "02",
    title: "Atender melhor",
    subtitle: "IA no atendimento e nas vendas.",
    lessons: [
      {
        id: "2.1",
        title: "Responder no WhatsApp mais rápido",
        youtube: "",
        c: {
          tool: "ChatGPT para rascunhar respostas, mais as respostas rápidas do WhatsApp.",
      ...
      {
        id: "2.2",
        title: "Um assistente para tirar dúvidas sozinho",
        youtube: "",
        c: {
          tool: "Um chatbot simples ou assistente de IA com as suas perguntas frequentes.",
      ...
      {
        id: "2.3",
        title: "Follow-up e pós-venda sem esquecer ninguém",
        youtube: "",
        c: {
          tool: "ChatGPT mais uma planilha ou a agenda do celular.",
    ...
    quiz: [
      {
        ...
        a: 1,
        e: "Respostas prontas mantêm qualidade e agilidade quando você está ocupado."
      },
      {
        ...
        a: 1,
        e: "Você não perde venda quando não está disponível."
      },
      {
        ...
        a: 1,
        e: "Uma mensagem de retomada bem feita recupera o cliente que sumiu."
      }
    ]
  },
  {
    ...
    num: "03",
    title: "Ganhar tempo",
    subtitle: "IA para a rotina do dia a dia.",
    lessons: [
      {
        id: "3.1",
        title: "Organizar as finanças e entender os números",
        youtube: "",
        c: {
          tool: "ChatGPT com análise de planilha.",
      ...
      {
        id: "3.2",
        title: "Resumir, planejar e escrever em minutos",
        youtube: "",
        c: {
          tool: "ChatGPT, e o NotebookLM para os seus documentos.",
    ...
    quiz: [
      {
        ...
        a: 1,
        e: "A IA lê a planilha e mostra onde cortar e o que dá lucro."
      },
      {
        ...
        a: 1,
        e: "Cole o texto, peça o resumo ou o rascunho, e só revise."
      },
      {
        ...
        a: 1,
        e: "Menos burocracia, mais tempo no negócio e no cliente."
      }
    ]
  }
];
const ALL_LESSONS = MODULES.flatMap(
  (m) => m.lessons.map((l) => ({ ...l, moduleId: m.id, moduleTitle: m.title, moduleNum: m.num }))
);
export {
  ALL_LESSONS as A,
  INTEGRANTES as I,
